...
### Funzioni di ricerca posizionali
...
La funzione progettata per **cercare la posizione della prima occorrenza** di un carattere o di un’altra stringa ``stringa`` all’interno della stringa è ``indexOf(stringa)``, la cui firma è la seguente:
...
La funzione progettata per **cercare la posizione dell'ultima occorrenza** di un carattere o di un’altra stringa ``stringa`` all’interno della stringa è ``lastIndexOf(stringa)``, la cui firma è la seguente:
...
```plaintext
Syntax: String.prototype.startsWith(stringa)
...
```plaintext
Syntax: String.prototype.toUpperCase()
