...
Graficamente un array lo possiamo rappresentare come una tabella nella quale sono memorizzati gli elementi e sono visualizzate le posizioni.
...
Come si può notare nell'esempio appena mostrato, la lunghezza dell'array è dieci, il primo elemento è memorizzato nella posizione 0 e l'ultimo elemento è memorizzato in posizione nove. In posizione due è memorizzato l'elemento otto ed in posizione sei è memorizzato l'elemento nove.
...
Come si può notare nell'esempio appena mostrato, la lunghezza dell'array è sette, il primo elemento è memorizzato nella posizione 0 e l'ultimo elemento è memorizzato in posizione sei. In posizione tre è memorizzato l'elemento ``p`` ed in posizione sei è memorizzato l'elemento ``=``.
...
In questa istruzione, abbiamo dichiarato un array il cui nome è ``v`` e tra parentesi quadre abbiamo specificato la lunghezza desiderata di 4 elementi (che saranno memorizzati nelle posizioni da zero a tre).
...
Ed in ambito informatico, la prima posizione di un array corrisponde all'indice zero.

In un array di lunghezza 10, il primo elemento si trova all'indice zero, la seconda posizione all'

Per dichiarare un array è necessario indicare il numero di elementi contenuti.
